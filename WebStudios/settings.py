"""
Django settings for WebStudios project.
...
SECRET_KEY = 'django-insecure-7!@q*+yknbubrw$&dgq9m)=fei@e4a@(5kwiy-y_o6m#+63_(e'
...
WSGI_APPLICATION = 'WebStudios.wsgi.application'
